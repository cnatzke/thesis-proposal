...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{two_photon_schematic.pdf}
...
This so-called non-competive two-photon decay has been observed in the doubly magic nuclei $^{16}$O, $^{40}$Ca \cite{schirmer_double_1984}, and $^{90}$Zr~\cite{schirmer_double_1984}. 
