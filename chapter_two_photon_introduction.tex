...
The differential decay rate for two-photon decay is given by 
...
According the Schirmer \textit{et al.} two-photon decay in $^{90}$Zr and $^{40}$Ca occurs not only through two E1 emission but also through equally strong 2M1 emissions. 
