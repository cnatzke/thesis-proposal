...
Table~\ref{tab:ga_beam_parameters} details the amount of data collected in hours and the average beam intensity during implantation.
...
\begin{table}[]
  ...
  \begin{tabular}{cccccc}
                      & Beam      & Ion Source & Tape Cycle   & Hours of  \\ Data Collected & Average Beam Intensity (pps) \\ \hline
  \textbf{Oct. 2017}  & $^{72}$Ga & Laser      & Implantation & 2.5                     & $1.5\times10^5$              \\
                      &           &            & Decay        & 202                     & -                            \\ \hline
  \textbf{Sept. 2017} & $^{72}$Ga & Laser      & Implantation & 0.5                     & $4.0\times10^4$              \\
                      &           &            & Decay        & 9.5                     & -                            \\ \hline
  \end{tabular}
...
\begin{itemize}
  ...
  \item The two $\gamma$-rays must sum to the full transition energy of 
\end{itemize}
