...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=5in]{isac_schematic.png}
...
\begin{figure}[htbp]
  \centering
  \subfloat{\includegraphics[height=6cm]{griffin_clover_schematic.jpg}}
  \quad
  \subfloat{\includegraphics[height=6cm]{hpge_picture.png}}
  \caption{
