...
Events that pass the primary collector are written to disk using the Maximum Integrated Data Acquisition System (MIDAS) frontend \cite{ritt_midas_1997}, developed by TRIUMF and the Paul Scherrer Institute. Data are written to disk using the GRIFFIN event format \cite{noauthor_griffin_nodate}.
