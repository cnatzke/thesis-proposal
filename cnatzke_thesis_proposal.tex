...
\usepackage{graphicx}
\usepackage{grffile}
\graphicspath{{graphics/}{../graphics/}{figures/}{../figures/}}
...
\chapter{Introduction to Nuclear Two-photon Decay}
\subfile{chapter_introduction_proposal}
%\subfile{chapter_TITAN_Facility_at_TRIUMF}
\subfile{chapter_Ion_Manipulation_and_DecaySpec_in_EBIT}
\subfile{chapter_Towards_NEEC_in_129Sb}
\subfile{chapter_Simulations}
%\subfile{chapter_Beam_Purification_in_an_MR_TOF}
%\subfile{chapter_Demonstration_of_beam_purification_in_MR_TOF}
\subfile{chapter_Conclusions}

%\subfile{chapter_theory}

%\subfile{chapter_experimental_setup}
%\subfile{chapter_daq}

%\subfile{chapter_HPGE}
%\subfile{chapter_analysis}
