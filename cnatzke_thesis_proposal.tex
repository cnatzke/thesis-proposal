...
\title{Thesis Proposal : Towards Searches for Nuclear Two-Photon Decay with GRIFFIN}
...
\chapter{Select Radiation Interactions with Matter}
\subfile{chapter_photon_interactions}

\chapter{The GRIFFIN Spectrometer at TRIUMF}
\subfile{chapter_griffin_at_triumf}

\chapter{Proof of Concept : $^{90}$Zr Two-Photon Decay}
\label{sec:proof_of_concept_90sr}
\subfile{chapter_proof_of_concept}

\chapter{Application to RIB : Mass 72 $\beta^-$ Decay}
\subfile{chapter_mass72_rib}

\chapter{Path to Completion}
